...
<head>
	...
	<link href="{{ asset('links//sticky-footer.css') }}" rel="stylesheet">

	<!-- Fonts -->

	<link href="{{ asset('/links/googlefontcss.css?family=Roboto:400,300') }}" rel='stylesheet' type='text/css'>
	<!--
	...
	<!--[if lt IE 9]>
		...
		hiv/3.7.2/html5shiv.min.js"></script>
...
<body>
	<nav class="navbar navbar-default .footer-bg" >
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav" style="text-color: #ffffff">
	...
	<div>
		<div class="container-fluid .footer-bg">
			<br>
			<div>
				<p class="pull-left small">© jacky's studio 2018</p>
			</div>
			<div>
				<p class="pull-right small">
					contact@ jackys97@hku.hk
				</p>
			</div>
		</div>
	</div>
	...
	{{ asset('links/jquerry.min.js') }}
	{{ asset('links/bootstrap.min.js') }}
